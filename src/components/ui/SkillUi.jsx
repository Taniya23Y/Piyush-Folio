  ...
  return (
    ...
    >
      <div className="Card relative rounded-lg border bg-gradient-to-r from-[#D1D2C4] to-[#D1D2C4] p-[2rem] w-full md:w-full lg:w-4/5">
        {/* <div className="Card relative rounded-lg border bg-gradient-to-r from-[#A9B895] to-[#DBDBDB] p-[2rem] w-full md:w-full lg:w-4/5"> */}
        {/* <div className="Card relative rounded-lg border bg-[#0BA34E]  p-[2rem] w-full md:w-full lg:w-4/5"> */}
